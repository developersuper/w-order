...
const ConfirmDeletePlace = ({ isOpen, closeModal, name }: { isOpen: boolean, closeModal: (data?: boolean) => void, name?: string }) => {
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="mt-4">
                                        <p className="text-base text-neutral-80">
                                            The QR code and menu link of {name} will no longer accessible.
                                        </p>
                                    </div>
...
export default ConfirmDeletePlace;